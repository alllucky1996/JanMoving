...
namespace Smartstore.Moving
{
    public class Events : IConsumer
    {
        ...
        {
            if (message.ModelName == nameof(VideoComment))
            {
        ...
        private static object CreateModelPart(VideoComment part, 
        ...
        {
            var newsComments = message.Customer.CustomerContent.OfType<VideoComment>();
        ...
        public void HandleEvent(CustomerAnonymizedEvent message)
        {
            ...
            foreach (var comment in message.Customer.CustomerContent.OfType<VideoComment>())
            {
