...
{
    [LocalizedDisplay("Admin.ContentManagement.Video.Fields.")]
    public class VideoItemModel : TabbableModel, ILocalizedModel<VideoItemLocalizedModel>
    {
        ...
        public List<VideoItemLocalizedModel> Locales { get; set; } = new();
        public string EditUrl { get; set; }
        public string CommentsUrl { get; set; }
    }

    [LocalizedDisplay("Admin.ContentManagement.Video.Fields.")]
    public class VideoItemLocalizedModel : ILocalizedLocaleModel
    {
        public int LanguageId { get; set; }
    ...
    public partial class VideoItemValidator : AbstractValidator<VideoItemModel>
    {
        public VideoItemValidator()
        {
    ...
    //    IMapper<VideoItem, VideoItemModel>,
    //    IMapper<VideoItemModel, VideoItem>
    //{
    //    private readonly IUrlHelper _urlHelper;
    //    private readonly IDateTimeHelper _dateTimeHelper;

    //    public VideoItemMapper(IUrlHelper urlHelper, IDateTimeHelper dateTimeHelper)
    //    {
    //        _urlHelper = urlHelper;
    //        _dateTimeHelper = dateTimeHelper;
    //    }

    //    public async Task MapAsync(VideoItem from, VideoItemModel to, dynamic parameters = null)
    //    {
    ...
    //    public Task MapAsync(VideoItemModel from, VideoItem to, dynamic parameters = null)
    //    {
    //        Guard.NotNull(from, nameof(from));
    //        Guard.NotNull(to, nameof(to));
