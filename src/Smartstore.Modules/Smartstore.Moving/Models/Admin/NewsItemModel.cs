...
namespace Smartstore.Moving.Models
{
    ...
    public class NewsItemMapper :
        IMapper<VideoItem, NewsItemModel>,
        IMapper<NewsItemModel, VideoItem>
    {
        ...
        public async Task MapAsync(VideoItem from, NewsItemModel to, dynamic parameters = null)
        {
        ...
        public Task MapAsync(NewsItemModel from, VideoItem to, dynamic parameters = null)
        {
            Guard.NotNull(from, nameof(from));
            Guard.NotNull(to, nameof(to));
