...
{
    public class NewsItemImageMapper : Mapper<VideoItem, ImageModel>
    {
        ...
        protected override void Map(VideoItem from, ImageModel to, dynamic parameters = null)
            => throw new NotImplementedException();

        public override async Task MapAsync(VideoItem from, ImageModel to, dynamic parameters = null)
        {
