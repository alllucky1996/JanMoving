...
namespace Smartstore
{
    ...
    {
        /// <summary>
        /// Applies standard filter and sorts descending by <see cref="VideoItem.CreatedOnUtc"/>.
        /// </summary>
        ...
        /// <param name="includeHidden">Applies filter by <see cref="VideoItem.Published"/>.</param>
        /// <returns>Ordered news item query.</returns>
        public static IOrderedQueryable<VideoItem> ApplyStandardFilter(
            this IQueryable<VideoItem> query,
            int storeId,
            int languageId = 0,
